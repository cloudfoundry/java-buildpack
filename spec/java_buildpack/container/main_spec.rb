...
describe JavaBuildpack::Container::Main do
  ...
  context do
    ...
    it 'should return command' do
      ...
      expect(component.release).to eq("#{java_home}/bin/java -cp $PWD/.:$PWD/.additional-libraries/test-jar-1.jar:" +
                                          "$PWD/.additional-libraries/test-jar-2.jar #{java_opts_str} " +
  ...
  it 'should return additional classpath entries when Class-Path is specified',
    ...
    expect(component.release).to eq("#{java_home}/bin/java -cp $PWD/.:$PWD/.additional-libraries/test-jar-1.jar:" +
                                        '$PWD/.additional-libraries/test-jar-2.jar:$PWD/alpha.jar:$PWD/bravo.jar:' +
