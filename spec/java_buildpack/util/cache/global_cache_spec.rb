...
require 'java_buildpack/util/cache/global_cache'

describe JavaBuildpack::Util::Cache::GlobalCache do
  ...
  context do
    ...
    it 'should use BUILDPACK_CACHE directory' do
      ...
      expect(Pathname.glob(buildpack_cache_dir + '*.cached').size).to eq(1)
    end
  end
