...
require 'spec_helper'
require 'tmpdir'
require 'java_buildpack/utils/global_cache'

describe JavaBuildpack::GlobalCache do
  ...
  it 'should raise an error if BUILDPACK_CACHE is not defined' do
    lambda { JavaBuildpack::GlobalCache.new }.should raise_error
  end
  ...
  it 'should use BUILDPACK_CACHE directory' do
    ...
    Dir.mktmpdir do |root|
      ...
      JavaBuildpack::GlobalCache.new().get('foo', 'http://foo-uri/') {}
